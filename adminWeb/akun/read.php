...
$stmt = $pdo->prepare('SELECT * FROM akun ORDER BY id_akun LIMIT :current_page, :record_per_page');
...
$num_dokters = $pdo->query('SELECT COUNT(*) FROM akun')->fetchColumn();
?>

<div class="content read">
	<h2>Data Akun</h2>
	<a href="./create.php" class="menu create-dokter" id="tambahDokter">Tambah Data Akun</a>
	<table>
        <thead>
            <tr>
                <td>akun id</td>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <a href="update.php?id_akun=<?=$akun['id_akun']?>" class="menu edit" id="edit"><i class="fas fa-pen fa-xs"></i></a>
                    <a href="delete.php?id_akun=<?=$akun['id_akun']?>" class="menu trash" id="hapus"><i class="fas fa-trash fa-xs"></i></a>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
